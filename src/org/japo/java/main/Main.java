...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Generar el año
        int any = rnd.nextInt(ANY_MAX - ANY_MIN + 1) + ANY_MIN;

        // Generar el mes
        int mes = rnd.nextInt(MES_MAX - MES_MIN + 1) + MES_MIN;

        // Averigurar si el año es bisiesto
        boolean bisiestoOK = any % 400 == 0 || any % 100 != 0 && any % 4 == 0;

        // Calcular los dias del mes generado
        int numDiasMes;
        ...
        // Generar el dia
        int dia = rnd.nextInt(numDiasMes) + 1;
